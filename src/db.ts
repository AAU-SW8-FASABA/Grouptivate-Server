...
export enum collectionEnum {Goal = "Goal", Group = "Group", User = "User", Invite = "Invite" }

const connectionString = process.env.ATLAS_URI || "";

if(connectionString == "")
  throw error("ATLAS_URI is not set")
...
export async function getFilter(_collection: collectionEnum, filter: object, project?: object) {
  const collection = db.collection(_collection);
  if(project)
...
export async function update(_collection: collectionEnum, id: string, data: object) {
...
export async function updateFilter(_collection: collectionEnum, filter: object, data: object) {
...
export async function remove(_collection: collectionEnum, filter: object) { //TODO: check om fejler
