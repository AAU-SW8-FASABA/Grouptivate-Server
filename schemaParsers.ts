...
export function parseInput(inputSchema: RequestSchema<SearchParametersSchema, any, any>, req: Request, res: Response){
  const parseRes = []
...
export function parseOutput(schema: RequestSchema<SearchParametersSchema, any, any>, data: WithId<Document> | object |Array<object>, res: Response){
